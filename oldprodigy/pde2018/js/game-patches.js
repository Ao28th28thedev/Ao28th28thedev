	...
	doGameMods() {
		...
		this.game.state.states.Login.screenSetup = function() {
			...
			a.alpha = .25, this.game.prodigy.create.font(this.background, a.x, a.y + 8, "Privacy Policy", {
				...
				width: 160,
				align: "center"
			}), a.setClickable(this.game.prodigy.network.openWebsite.bind(this.game.prodigy.network, "www.prodigygame.com/privacy-policy/")), a = this.game.prodigy.create.panel(this.background, 280, 660, 3, 1, "lb"), a.alpha = .25, this.game.prodigy.create.font(this.background, a.x, a.y + 8, "Home", {
				size: 16,
				width: 120,
				align: "center"
			}), a.setClickable(this.game.prodigy.network.openWebsite.bind(this.game.prodigy.network, "xpmuser.github.io/")),
			this.showLogin(!0),
			this.checkForAdmin(),
